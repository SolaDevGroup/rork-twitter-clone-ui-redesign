...
export const posts: Post[] = [
  {
    ...
    user: {
      ...
      name: 'Display Name',
      username: 'username',
      avatar: 'https://ui-avatars.com/api/?name=Display+Name&background=4353FF&color=fff&size=200',
      bio: 'Digital creator',
    ...
    content: 'Who was the most influential individual in 2025?',
    ...
    views: 1500000,
    isLiked: false,
    hashtags: ['Crypto', 'Crypto', 'Crypto'],
    poll: {
      id: 'poll-1',
      question: 'Who was the most influential individual in 2025?',
      options: [
        {
          id: 'opt-1',
          text: '"Jensen" Huang',
          votes: 1400,
          voters: [
            { id: '1', name: 'Webflow', username: 'webflow', avatar: 'https://ui-avatars.com/api/?name=Webflow&background=4353FF&color=fff&size=40', joinedDate: '', following: 0, followers: 0, isVerified: true },
            { id: '2', name: 'User2', username: 'user2', avatar: 'https://ui-avatars.com/api/?name=User2&background=22C55E&color=fff&size=40', joinedDate: '', following: 0, followers: 0 },
            { id: '3', name: 'User3', username: 'user3', avatar: 'https://ui-avatars.com/api/?name=User3&background=EF4444&color=fff&size=40', joinedDate: '', following: 0, followers: 0 },
          ],
        },
        {
          id: 'opt-2',
  ...
  },
  {
    ...
    user: {
      ...
      name: 'username',
      username: 'username',
      avatar: 'https://ui-avatars.com/api/?name=Username&background=78706B&color=fff&size=200',
      bio: 'Content creator',
      joinedDate: 'March 2023',
      following: 800,
      followers: 25000,
    },
    content: 'Google Fonts makes it easy to bring personality and performance to your websites and products. Our robust catalog of open-source fonts and icons makes it easy to integrate expressive type and icons seamlessly — no matter where you are in the world.',
    timestamp: '9 hours ago',
    likes: 1400,
    comments: 919,
    reposts: 1500,
    ...
    video: {
      ...
      thumbnail: 'https://images.unsplash.com/photo-1560439514-e960a3ef5019?w=800',
      duration: '0:57',
      hasSubtitles: true,
    },
  },
